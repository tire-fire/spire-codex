...
Ratings come from community-submitted runs: Codex Score grades a card's win rate when picked against the average, so B is average and S warps runs. This is Silent as of mid-July 2026 on the main branch; the [live tier list](https://spire-codex.com/tier-list/cards?color=silent) updates continuously and can slice by bracket.
